...
Szoftverfejlesztő cég			EWT Kft
Jankuráné Szabó Csilla 			Backend fejlesztő / Megbeszélés moderátora 
Lovász Ferenc				Tesztelés
Sas Attila				Frontend fejlesztő 

Jankuráné Szabó Csilla üdvözölte a jelenlevőket, összefoglalta a 
...
2. Kezdőlap véglegesítése
	A kezdőlapon a következő menüpontok kerültek elfogadásra: 
		- Főoldal
		- Könyvlista
		- Könyvfelvitel
		- Kapcsolat
	Az eredeti tervekhez képest az Egyébb menüpont eltávolítását kérték. 
	A kezdőlapon megjelenő bemutatkozó szöveget a Fanatikvárium írásban juttatja 
	el a fejlesztőknek 2018. 01. 07-ig. 
	
A következő megbeszélés időpontja kitűzésre került. A megbeszélés témája
